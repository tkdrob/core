...
async def test_window_cover(hass, client, chain_actuator_zws12, integration):
    ...
    assert state
    assert state.attributes[ATTR_DEVICE_CLASS] is CoverDeviceClass.WINDOW
...
async def test_fibaro_FGR222_shutter_cover(
    ...
    assert state
    assert state.attributes[ATTR_DEVICE_CLASS] is CoverDeviceClass.SHUTTER
...
async def test_blind_cover(hass, client, iblinds_v2, integration):
    ...
    assert state
    assert state.attributes[ATTR_DEVICE_CLASS] is CoverDeviceClass.BLIND
...
async def test_motor_barrier_cover(hass, client, gdc_zw062, integration):
    ...
    assert state
    assert state.attributes[ATTR_DEVICE_CLASS] is CoverDeviceClass.GARAGE
