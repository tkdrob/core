...
async def test_numeric_sensor(hass, multisensor_6, integration):
    ...
    assert state.attributes["device_class"] is SensorDeviceClass.TEMPERATURE
    ...
    assert state.attributes["device_class"] is SensorDeviceClass.BATTERY
    ...
    assert state.attributes["unit_of_measurement"] == "%"
    assert state.attributes["device_class"] is SensorDeviceClass.HUMIDITY
...
async def test_energy_sensors(hass, hank_binary_switch, integration):
    ...
    assert state.attributes["device_class"] is SensorDeviceClass.POWER
    ...
    assert state.attributes["device_class"] is SensorDeviceClass.ENERGY
    ...
    assert state.attributes["device_class"] is SensorDeviceClass.VOLTAGE
    ...
    assert state.attributes["device_class"] is SensorDeviceClass.CURRENT
...
async def test_meter_attributes(
    ...
    assert state.attributes[ATTR_DEVICE_CLASS] is SensorDeviceClass.ENERGY
